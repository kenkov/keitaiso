...
class Keitaiso(object):
    ...
    def __init__(self, chasen_data):
        ...
        (self._hyousoukei, self._hinsi,
         self._hinsi1, self._hinsi2,
         self._hinsi3, self._katuyoukei,
         self._katuyougata, self._genkei,
         self._yomi, self._hatuon) = self._parse_keitaiso(chasen_data)

    @property
    def chasen_data(self):
    ...
    def __cmp__(self, other):
        ...
        return 0 if (self._hyousoukei == other._hyousoukei and
                     ...
                     self._hatuon == other._hatuon) else 1
    ...
    def __unicode__(self):
        return u'{hy},{h},{h1},{h2},{h3},{kk},{kg},{g},{y},{ha}'.format(
            hy=self._hyousoukei,
            h=self._hinsi,
            h1=self._hinsi1,
            h2=self._hinsi2,
